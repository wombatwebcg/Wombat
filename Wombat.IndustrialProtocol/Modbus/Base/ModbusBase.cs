...
namespace Wombat.IndustrialProtocol.Modbus
{
    public abstract class ModbusBase : BaseMessageModel, IModbusClient
    {
        ...
        /// <returns></returns>
        public abstract  OperationResult<byte[]> Read(string address, int readLength = 1, byte stationNumber = 1, byte functionCode = 3);
        ...
        public OperationResult<short[]> ReadInt16(string address, int readLength, byte stationNumber = 1, byte functionCode = 3)
        {
            var readResut = Read(address, readLength, stationNumber, functionCode);
            var result = new OperationResult<short[]>(readResut);
            if (result.IsSuccess)
                result.Value = readResut.Value.TransInt16(0, readLength,true);
            return result.EndTime();
        }
        ...
        public OperationResult<ushort[]> ReadUInt16(string address, ushort readLength, byte stationNumber = 1, byte functionCode = 3)
        {
            var readResut = Read(address, readLength, stationNumber, functionCode);
            var result = new OperationResult<ushort[]>(readResut);
            if (result.IsSuccess)
                result.Value = readResut.Value.TransUInt16(0, readLength, true);
            return result.EndTime();
        }
        ...
        {
            var readResut = Read(address, 2, stationNumber, functionCode);
        ...
        /// <param name="functionCode">功能码</param>
        /// <returns></returns>
        public OperationResult<int[]> ReadInt32(string address, int readLength, byte stationNumber = 1, byte functionCode = 3)
        {
            var readResut = Read(address, (ushort)(2*readLength), stationNumber, functionCode);
            var result = new OperationResult<int[]>(readResut);
            if (result.IsSuccess)
                result.Value = readResut.Value.TransInt32(0,length: readLength,format:DataFormat,reverse:IsReverse);
            return result.EndTime();
        }
        ...
        public OperationResult<uint> ReadUInt32(string address, byte stationNumber = 1, byte functionCode = 3)
        {
            ...
            if (result.IsSuccess)
                result.Value = readResut.Value.TransUInt32(0,format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        ...
        /// <param name="functionCode">功能码</param>
        /// <returns></returns>
        public OperationResult<uint[]> ReadUInt32(string address, int readLength, byte stationNumber = 1, byte functionCode = 3)
        {
            var readResut = Read(address, 2* readLength, stationNumber, functionCode);
            var result = new OperationResult<uint[]>(readResut);
            if (result.IsSuccess)
                result.Value = readResut.Value.TransUInt32(0,length: readLength, format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        ...
        {
            var readResut = Read(address,4, stationNumber, functionCode);
            var result = new OperationResult<long>(readResut);
            if (result.IsSuccess)
                result.Value = readResut.Value.TransInt64(0, format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        ...
        /// <param name="functionCode">功能码</param>
        /// <returns></returns>
        public OperationResult<long[]> ReadInt64(string address, int readLength, byte stationNumber = 1, byte functionCode = 3)
        {
            var readResut = Read(address, 4*readLength, stationNumber, functionCode);
            var result = new OperationResult<long[]>(readResut);
            if (result.IsSuccess)
                result.Value = readResut.Value.TransInt64(0,readLength, format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        ...
        public OperationResult<ulong> ReadUInt64(string address, byte stationNumber = 1, byte functionCode = 3)
        {
            ...
            if (result.IsSuccess)
                result.Value = readResut.Value.TransUInt64(0, format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        /// <summary>
        /// 读取UInt64
        ...
        /// <param name="functionCode">功能码</param>
        /// <returns></returns>
        public OperationResult<ulong[]> ReadUInt64(string address, int readLength, byte stationNumber = 1, byte functionCode = 3)
        {
            var readResut = Read(address, 4 * readLength, stationNumber, functionCode);
            var result = new OperationResult<ulong[]>(readResut);
            if (result.IsSuccess)
                result.Value = readResut.Value.TransUInt64(0, readLength, format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        ...
        public OperationResult<float> ReadFloat(string address, byte stationNumber = 1, byte functionCode = 3)
        {
            ...
            if (result.IsSuccess)
                result.Value = readResut.Value.TransFloat(0, format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        ...
        /// <param name="functionCode">功能码</param>
        /// <returns></returns>
        public OperationResult<float[]> ReadFloat(string address, int readLength, byte stationNumber = 1, byte functionCode = 3)
        {
            var readResut = Read(address, 2*readLength, stationNumber, functionCode);
            var result = new OperationResult<float[]>(readResut);
            if (result.IsSuccess)
                result.Value = readResut.Value.TransFloat(0,readLength ,format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        ...
        public OperationResult<double> ReadDouble(string address, byte stationNumber = 1, byte functionCode = 3)
        {
            ...
            if (result.IsSuccess)
                result.Value = readResut.Value.TransDouble(0,format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        ...
        /// <param name="functionCode">功能码</param>
        /// <returns></returns>
        public OperationResult<double[]> ReadDouble(string address, int readLength, byte stationNumber = 1, byte functionCode = 3)
        {
            var readResut = Read(address, 4*readLength, stationNumber, functionCode);
            var result = new OperationResult<double[]>(readResut);
            if (result.IsSuccess)
                result.Value = readResut.Value.TransDouble(0,readLength, format: DataFormat, reverse: IsReverse);
            return result.EndTime();
        }
        ...
        /// <param name="functionCode">功能码</param>
        /// <returns></returns>
        public OperationResult<bool[]> ReadCoil(string address, int readLength, byte stationNumber = 1, byte functionCode = 1)
        {
            var readResut = Read(address,readLength, stationNumber, functionCode);
            var result = new OperationResult<bool[]>(readResut);
            if (result.IsSuccess)
        ...
        /// <param name="functionCode"></param>
        /// <returns></returns>
        public OperationResult<bool[]> ReadDiscrete(string address, int readLength, byte stationNumber = 1, byte functionCode = 2)
        {
            var readResut = Read(address, stationNumber, functionCode);
            var result = new OperationResult<bool[]>(readResut);
            if (result.IsSuccess)
        ...
        private OperationResult<Dictionary<string, object>> BatchRead(Dictionary<string, DataTypeEnum> addressList, byte stationNumber, byte functionCode)
        {
            ...
            while (maxAddress >= minAddress)
            {
                ...
                var tempOperationResult = Read(minAddress.ToString(), Convert.ToUInt16(readLength), stationNumber, functionCode);
