...
namespace Wombat.Sockets
{
    public class TcpSocketClient : IDisposable
    {
        ...
        private static ILogger<TcpSocketClient> Logger => new SerilogLoggerFactory(LogHelper.Log).CreateLogger<TcpSocketClient>();
            ...
            var validateRemoteCertificate = new RemoteCertificateValidationCallback(
                ...
                =>
                {
                    ...
                    if (_configuration.SslPolicyErrorsBypassed)
                        ...
                        Logger?.LogError($"Error occurred when validating remote certificate: [{this.RemoteEndPoint}], [{sslPolicyErrors}].");
    ...
    $"CipherStrength[{sslStream.CipherStrength}]."
        ...
        private void HandleDataReceived(IAsyncResult ar)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Logger?.LogError(innnerException.Message, innnerException);
                }
            }
        }
        ...
        {
            Logger?.LogError(string.Format("Client [{0}] error occurred in user side [{1}].", this, ex.Message), ex);
        }
        ...
        {
            ServerConnected?.Invoke(this, new TcpServerConnectedEventArgs(this.RemoteEndPoint, this.LocalEndPoint));
        }
