...
namespace Wombat.Sockets
{
    public sealed class AsyncTcpSocketSession
    {
        ...
        private static ILogger<AsyncTcpSocketSession> Logger => new SerilogLoggerFactory(LogHelper.Log).CreateLogger<AsyncTcpSocketSession>();
        ...
        internal async Task Start()
        {
            ...
            try
            {
                ...
                Logger?.LogDebug($"Session started for [{this.RemoteEndPoint}] on [{this.StartTime.ToString(@"yyyy-MM-dd HH:mm:ss.fffffff")}] " +
        ...
        private async Task<Stream> NegotiateStream(Stream stream)
        {
            ...
            var validateRemoteCertificate = new RemoteCertificateValidationCallback(
                ...
                =>
                {
                    ...
                    if (_configuration.SslPolicyErrorsBypassed)
                        ...
                        Logger?.LogError($"Session [{this}] error occurred when validating remote certificate: [{this.RemoteEndPoint}], [{sslPolicyErrors}].");
            ...
            // Check the IsMutuallyAuthenticated property to determine whether mutual authentication occurred.
                        Logger?.LogDebug($"Ssl Stream: SslProtocol[{sslStream.SslProtocol}], " +
        ...
        private async Task Close(bool shallNotifyUserSide)
        {
            ...
            {
                Logger.LogDebug($"Session closed for [{this.RemoteEndPoint}] " +
