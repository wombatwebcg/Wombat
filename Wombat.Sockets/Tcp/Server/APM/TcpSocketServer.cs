...
namespace Wombat.Sockets
{
    public class TcpSocketServer
    {
        ...
        private static  ILogger<TcpSocketServer>Logger => new SerilogLoggerFactory(LogHelper.Log).CreateLogger<TcpSocketServer>();
        ...
        {
            Logger?.LogError($"Session [{session}] error occurred in user side [{ex.Message}].");
        }
